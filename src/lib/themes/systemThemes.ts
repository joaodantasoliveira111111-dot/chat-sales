export const systemThemes = [
  ...
  {
    id: 'premium_product_chat',
    name: 'Produto Premium + Chat',
    description: 'Template escuro e tecnológico com apresentação do produto no topo e venda conversacional abaixo.',
    is_system: true,
    config: {
      background: '#050B14',
      ...
      chatContainerBorder: 'rgba(255,255,255,0.08)',
